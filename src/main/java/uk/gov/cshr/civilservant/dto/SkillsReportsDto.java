...
public class SkillsReportsDto {
    ...
    public SkillsReportsDto(String quizName, Status status, String professionName, long questionId, String questionName, String questionTheme, long timesAttempted, long correctCount, long incorrectCount, long skippedCount) {
