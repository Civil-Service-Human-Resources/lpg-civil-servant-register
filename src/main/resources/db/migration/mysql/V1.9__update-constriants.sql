ALTER TABLE `civil_servant` DROP FOREIGN KEY `fk_grade_id`;
...
ALTER TABLE `civil_servant` DROP FOREIGN KEY `fk_organisational_unit_id`;
...
ALTER TABLE `civil_servant` DROP FOREIGN KEY `fk_profession_id`;
